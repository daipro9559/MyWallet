...
public class SetOptionsOperation extends Operation {
  ...
  com.example.stellar.xdr.Operation.OperationBody toOperationBody() {
    ...
    if (signer != null) {
      com.example.stellar.xdr.Signer signer = new com.example.stellar.xdr.Signer();
  ...
  public static class Builder {
     ...
     * @param signer The signer key. Use {@link com.example.stellar.Signer} helper to create this object.
