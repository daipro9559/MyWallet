...
import com.example.stellar.xdr.TransactionResult;
import com.example.stellar.xdr.XdrDataInputStream;
 ...
 * @see Server#submitTransaction(com.example.stellar.Transaction)
 */
