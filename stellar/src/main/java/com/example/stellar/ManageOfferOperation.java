...
import com.example.stellar.xdr.CreateAccountOp;
import com.example.stellar.xdr.Int64;
import com.example.stellar.xdr.ManageOfferOp;
...
public class ManageOfferOperation extends Operation {
   ...
   * {@link com.example.stellar.ManageOfferOperation.Builder#setOfferId(long)}.
