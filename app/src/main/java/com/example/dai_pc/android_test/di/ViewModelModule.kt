...
import com.example.dai_pc.android_test.view.rate.RateViewModel
...
abstract class ViewModelModule{
    ...
    abstract fun manageAccountViewModel(manageAccountViewModel: ManageAccountViewModel) : ViewModel
